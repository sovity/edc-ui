...
import {DataCategorySelectItemService} from '../../routes/connector-ui/asset-create-page/data-category-select/data-category-select-item.service';
...
import {DataSubcategorySelectItemService} from '../../routes/connector-ui/asset-create-page/data-subcategory-select/data-subcategory-select-item.service';
