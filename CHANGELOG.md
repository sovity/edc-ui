...
- Broker UI: Catalog page no longer supports query parameter "connectorEndpoint" to filter connectors
- Broker UI: Catalog page now supports query parameter "mdsId" to filter connectors
